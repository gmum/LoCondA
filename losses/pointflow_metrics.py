...
from losses.StructuralLosses.match_cost import match_cost
from losses.StructuralLosses.nn_distance import nn_distance
...
def EMD_CD(
    sample_pcs, ref_pcs, batch_size, accelerated_cd=False, reduced=True
):
